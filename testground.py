...
if __name__ == '__main__':
    new_neuron_flag = False; sample_flag=True; sholl_flag=True;
    ...
    pairing_feat = pairing_feature(dgms, n_bin=20)
    ...
    extra_features = extra_features_processor(extra_features, type='1')
